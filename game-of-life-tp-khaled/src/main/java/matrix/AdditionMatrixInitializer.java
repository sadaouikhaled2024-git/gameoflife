...
public class AdditionMatrixInitializer implements MatrixInitializer<Integer> {

    private final Matrix<Integer> matrix1;
    private final Matrix<Integer> matrix2;


    public AdditionMatrixInitializer(Matrix<Integer> matrix1, Matrix<Integer> matrix2) {
